...
import GlobalFilter from "./GlobalFilter";
           ...
           const tableInstance = useTable({                                                             
               ...
               columns,
               data
           },useFilters,         //----- call before useglobal
           useGlobalFilter)          
           ...
           const { getTableProps,
            state,  
                               //----- for the tracking of state
            setGlobalFilter,  //-----this is for updatng the filter as state contains many properties and globalfilter is one for tracking the state of the input
               footerGroups,
               getTableBodyProps,
               headerGroups,               //-----headerGroups, if your table has groupings
               rows,                  //-----rows for the table based on the data passed
               ...
               const { globalFilter} = state     //----- here we  destructed  with state with globalfilter bcoz for update we use setglobalfilter as here set state is not valid



               return(
                   <>
                   <GlobalFilter filter={globalFilter} setfliter={setGlobalFilter}/>
                   <table {...getTableProps()}>
                       <thead>
                           {
                               headerGroups.map((headerGroup)=>(              //-----header gruops are groupo of headers but here we never grouped any of the columns        every column has its own header column
           ...
           {/* //----- the filter we used as we declred in column .js like headers */}
                                       </th>         
